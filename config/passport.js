...
var AccessToken    	= require('../models/User').AccessToken;
var RefreshToken   	= require('../models/User').RefreshToken;
...
// =========================================================================
        ...
        'tokens.accessToken': accessToken
          ...
          .exec( function (err, user) {
            if (err) { return done(null, true, { error: err , http_code: 400}); }
            if (!user) { return done(null, true, { error: 'Unknown user' , http_code: 401}); }
...
passport.use('venmo', new OAuth2Strategy({
    authorizationURL: 'https://oauth.venmo.com/v1/oauth/authorize',
    tokenURL: 'https://oauth.venmo.com/v1/oauth/access_token',
