...
module.exports = {
  ...
  paypal: {
    ...
    returnUrl: process.env.PAYPAL_RETURN_URL || 'http://localhost:3000/oauth/paypal/success',
    cancelUrl: process.env.PAYPAL_CANCEL_URL || 'http://localhost:3000/oauth/paypal/cancel'
  },
